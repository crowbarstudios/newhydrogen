...
<section class="bg-banner bg-cover bg-[18%_100%] md:bg-center relative md:pb-36 md:pt-28 py-16 " style="background-image: url('./assets/images/dark-bat.png');">
